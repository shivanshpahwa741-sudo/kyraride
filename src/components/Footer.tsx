      ...
      <div className="kyra-container">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <a 
            ...
            className="inline-flex items-center gap-3 text-accent hover:text-accent/80 transition-colors text-xl font-medium mb-3"
          >
          ...
          <a 
            ...
            className="inline-flex items-center gap-3 text-muted-foreground hover:text-accent transition-colors text-base mb-8"
          >
