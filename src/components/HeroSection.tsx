    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 kyra-container text-center">
        ...
        >
          <Link
            to="/auth"
            className="inline-block min-w-[220px] px-12 py-5 bg-[hsl(32,35%,87%)] text-[hsl(351,55%,12%)] font-semibold text-lg rounded-lg transition-all duration-300 ease-out hover:scale-105 hover:shadow-[0_0_30px_rgba(232,216,196,0.5)] text-center"
          >
            Reserve Your Ride
          </Link>
          <a
            ...
            className="inline-block min-w-[220px] px-12 py-5 bg-transparent border-2 border-accent text-accent font-semibold text-lg rounded-lg transition-all duration-300 ease-out hover:bg-accent/10 text-center"
          >
            Enquire Now
          </a>
        </motion.div>
